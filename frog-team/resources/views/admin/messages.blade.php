<x-layout>
    ...
    <div class="container mx-auto shadow-lg rounded-lg py-5 mt-5 border border-blue-500">
        <!-- header -->
    <div class="px-5 py-5 flex justify-between items-center bg-white border-b-2">
    <div class="font-semibold text-2xl">Ma-Mabg Chat</div>
    <div
    ...
    <div class="flex flex-col w-2/5 border-r-2 overflow-y-auto">
        ...
        <div class="w-full">
            <div class="text-lg font-semibold">Javascript Indonesia</div>
            <span class="text-gray-500">Evan : Did you manage to get the drugs? 🥦</span>
        </div>
        </div>
